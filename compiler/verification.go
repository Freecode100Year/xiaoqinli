...
var targetVerification = map[string]TargetVerification{
	...
	"haskell":    {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
	"ocaml":      {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
	...
	"crystal":    {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
	...
	"elixir":     {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
