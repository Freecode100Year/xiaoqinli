...
var targetVerification = map[string]TargetVerification{
	...
	"js":         {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
	"cpp":        {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
	"c":          {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
	"nim":        {TierSmoke, "TestExampleTargetMatrix", "", "rejects Result<T>"},
	...
	"scala":      {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"haskell":    {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"ocaml":      {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"fsharp":     {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"ada":        {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"awk":        {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"bash":       {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"crystal":    {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"d":          {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"fortran":    {TierSmoke, "TestExampleTargetMatrix", "", "rejects for-each loops"},
	"objc":       {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"pascal":     {TierSmoke, "TestExampleTargetMatrix", "", "rejects for-each loops"},
	"perl":       {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"powershell": {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"tcl":        {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"v":          {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"elixir":     {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"clojure":    {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"vala":       {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"groovy":     {TierSmoke, "TestExampleTargetMatrix", "", ""},
	"bat":        {TierSmoke, "TestExampleTargetMatrix", "", "rejects struct literals"},
	"shortcut":   {TierSmoke, "TestExampleTargetMatrix", "", "emits an Apple Shortcuts plist, not source"},
	"chrome":     {TierSmoke, "TestExampleTargetMatrix", "", "emits an extension bundle"},
	"tccli":      {TierSmoke, "TestExampleTargetMatrix", "", ""},
